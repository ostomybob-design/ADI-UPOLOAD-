...
-- ===================================================================
-- This will create the tables needed for the admin content management
...
SELECT 'ticker_messages' as table_name, COUNT(*) as row_count FROM ticker_messages
UNION ALL
SELECT 'quotes', COUNT(*) FROM quotes
UNION ALL
SELECT 'joke_of_the_day', COUNT(*) FROM joke_of_the_day;
